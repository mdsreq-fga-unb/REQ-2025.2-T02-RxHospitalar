...
| Backend            | Responsável por implementar algoritmos de análise de dados, integração com sistemas existentes e migração de dados das planilhas existentes e criação de views para diferentes perfis de usuário. | Samuel            | Davi, Eduardo, |
...
| Infraestrutura e CI| Responsável por configurar o ambiente de desenvolvimento, testes e produção para suportar o sistema de análise de dados.                     | Davi         | Gabriel                       |
...
- **Comunicação Semanal com o Cliente:** Através do P.O e/ou do grupo de comunicação como cleinte a equipe buscará manter o contato para  para fins de transparência sobre o progresso e validação do produto. OS comunicados através dos canais oficiais e possíveis reuniões com o cliente, que dependem da sua disponibilidade, serão documentadas através de uma ata.
...
**Teste de Aceitação do Usuário (UAT):** Após a conclusão do desenvolvimento de todas as funcionalidades planejadas, ocorrerá o Teste de Aceitação final. Nesta fase:  
  ...
  - O sucesso nesta etapa formaliza que a solução, como um todo, atende aos requisitos e está de acordo com as necessidades do cliente para uso real.
