---
sidebar_label: "Avaliação da ReqTech - PBB e BDD"
sidebar_position: 3
---
...
- [X] Os principais problemas (estado atual) estão explicitados?

- [X] As expectativas ou objetivos do produto/serviço estão documentados?

## Personas

- [X] As principais personas (tipos de usuário/participante) foram mapeadas?

- [X] Há clareza sobre as necessidades ou expectativas de cada persona?
...
- [X] O material torna clara a relação entre problemas, funcionalidades, histórias e critérios?