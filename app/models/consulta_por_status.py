...
import re
import pandas as pd
from typing import Set, Optional # Adicionado para compatibilidade com Python < 3.10
...
# CORREÇÃO AQUI: Uso de Set e Optional ao invés de set[] e |
def _achar_coluna(df: pd.DataFrame, aliases: Set[str], prefix: Optional[str] = None) -> Optional[str]:
